                  ...
                  <div class="l_side" style="">
                    <div>
                      ...
                      <input
                        ...
                        v-on:input="checkDisableNextStep(step,'top up
                              addr')"
                        autocomplete="off"
                      />
                    </div>
                  ...
                  <div style="display: inline-block">
                    ...
                    >
                      <div
                        class="icon_02"
                        :style="'background-image:
                                url(images/icon_havewallet.png);'"
                      ></div>
                      <p>我已有數字貨幣錢包</p>
                    </button>
                  </div>
                ...
                <div style="margin-top: 1.5em">
                  ...
                  >
                    <button
                      v-if="bankObj.avb"
                      :class="(bankObj.short ==
                            selectedBank)?btn_selected_style:btn_normal_style"
                      :key="bankObj.code"
                      v-on:click.stop.prevent="selectedBank=bankObj.short;
                            checkDisableNextStep(step, 'selectBank allow');"
                    >
                    ...
                    <button
                      ...
                      :key="bankObj.code"
                      v-on:click.stop.prevent="selectedBank=bankObj.short;
                            checkDisableNextStep(step, 'selectBank disabled');"
                      disabled
                    >
                      <div :class="'icon_MYR_' + bankObj.code"></div>
                      <p>{{ bankObj.name }}</p>
